...
public class ScheduleBean implements Serializable {
    ...
    public void init() {
        ...
        DefaultScheduleEvent event = DefaultScheduleEvent.builder()
                ...
                .description("She needs grain-free food.")
                .build();
        eventModel.addEvent(event);
 
        event = DefaultScheduleEvent.builder()
                .title("Cat Kattie needs a bath")
                .startDate(today1Pm())
                .endDate(today6Pm())
                .description("The cat has a bad temper and loves to scratch. :(")
                .overlapAllowed(true)
                .build();
        eventModel.addEvent(event);
 
        event = DefaultScheduleEvent.builder()
                .title("Take Photos for fish Lily")
